...
def is_phone_number_valid(phone_number: str) -> tuple[bool, str]:
    ...
    try:
        ...
        validated_response = PhoneIntelligenceResponse(
            ...
            phone_registration=PhoneRegistrationDetails(**response.get("phone_registration")),
        ...
        is_valid_phone_number = validated_response.phone_validation.is_valid \
            and not validated_response.phone_validation.is_voip \
            and validated_response.phone_validation.line_status == "active"

        is_verified_phone_number = validated_response.phone_carrier.line_type == "mobile" \
...
def is_email_valid(email: str) -> bool:
    ...
    try:
        validated_response = ValidateEmailResponse(
            ...
            is_catch_all_email=EmailValidationNested(**response.get("is_catchall_email")),
